...
def create_walls(fname: str, query: str, show: bool = False) -> None:
    ...
    _save_map(walled_fname, walled_map, show)
...
def create_terrain(fname: str, max_runs: int, show: bool = False) -> str:
    ...
    terrained_map, rake_paths, result_msg = _evolutionize(walled_map, max_runs)

    _save_solution(rake_paths, fname)

    terrained_fname = fname + "_ter"
    _save_map(terrained_fname, terrained_map, show)
...
def create_properties(
    ...
    _save_map(propertied_fname, propertied_map, show, "{:^5}")
...
def _evolutionize(
    ...
    Returns:
        Tuple[List[List[int]], Dict[Tuple[int, int], int], str]: (
    ...
    map_list_filled = _fill_map(map_list, fit_max_map)

    return map_list_filled, fit_max_path, result_msg
